...
export function GyroscopeGraph({ 
  ...
  const [visibleData, setVisibleData] = useState<GyroscopeData[]>([]);
        ...
        <div className="h-[300px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              />
              <YAxis 
                label={{ value: 'Angular Velocity (deg/s)', angle: -90, position: 'insideLeft', offset: -15, dy: 50 }}
                width={60}
              />
              <Tooltip 
                formatter={(value, name) => [`${value.toFixed(2)} deg/s`, name]}
